...
import StatsWindow from "./windows/StatsWindow.vue";
import SkinWindow from "./windows/SkinWindow.vue";
import HelpWindow from "./windows/HelpWindow.vue";
import ResourceWindow from "./windows/ResourceWindow.vue";
import AccountWindow from "./windows/AccountWindow.vue";
