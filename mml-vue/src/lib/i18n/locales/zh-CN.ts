...
"detail.logs": "实例日志",
  ...
  "winSettings.skinDisplayDesc": "账户皮肤悬停预览使用 2D 平铺、2D 叠加还是 3D 模型",
  "winSettings.skin2da": "2D 平铺",
  "winSettings.skin2db": "2D 叠加",
  "winSettings.skin3d": "3D 模型",
  "winSettings.headDisplay": "头像显示模式",
  "winSettings.headDisplayDesc": "账户头像的渲染方式（3D 旋转模式可调角度）",
  "winSettings.headType2DA": "2D 平铺",
  "winSettings.headType2DB": "2D 叠加",
  "winSettings.headType3DA": "3D 俯视",
  "winSettings.headType3DC": "3D 仰视",
