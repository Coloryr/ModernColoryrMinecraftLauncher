...
pub const LIB_DIR: &str = "libraries";
...
pub const GAME_CRASH_LOG_DIR: &str = "crash-reports";
pub const GAME_DATAPACK_DIR: &str = "datapacks";
pub const GAME_MOD_DIR: &str = "mods";
...
pub const GAME_SCREEN_SHOT_DIR: &str = "screenshots";
pub const GAME_RESOURCEPACK_DIR: &str = "resourcepacks";
pub const GAME_SHADERPACK_DIR: &str = "shaderpacks";
