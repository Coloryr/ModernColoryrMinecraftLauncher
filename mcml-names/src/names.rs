...
pub const NAME_LITELOADER_FILE: &str = "liteloader.json";
...
pub const NAME_NEOFORGE_KEY: &str = "neoforge";
pub const NAME_NEOFORGED_KEY: &str = "neoforged";
...
pub const NAME_FORGE_INSTALL: &str = "install";
...
pub const NAME_TAR_XZ_EXT: &str = ".tar.xz";
pub const NAME_TGZ_EXT: &str = ".tgz";
pub const NAME_TXZ_EXT: &str = ".txz";
